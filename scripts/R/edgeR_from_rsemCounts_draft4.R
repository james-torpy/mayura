...
# create function to count the number of CPM values equal to 0 for each gene, and make separate lists of genes with one, two,
# three, four counts of CPM values equal to 0
...
# make function to remove log values from up_genes from genes with CPM=0 counts of >=3 for Wt, Egr2, or both:
...
# remove log values from up_genes from genes with CPM=0 counts of >=3 for Wt, Egr2, or both:
